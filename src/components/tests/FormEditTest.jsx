...
const FormEditTest = ({ coursesName, tests }) => {
  ...
  const valuesTest = {
    ...
    duracion: '',
    preguntas: '',
    curso_relacionado_uno: tests.curso_relacionado_uno || '',
    ...
    <div>
      <Formik
        ...
        onSubmit={async (valores) => {
          ...
          editTest(dispatch, preguntasMult, tests.id, router)
        }}>
            ...
            return (
              ...
              <Form className="p-0 md:p-5 flex justify-center flex-col w-10/12 m-auto">
                ...
                <div className='my-2 mb-3'>
                  <label className="block text-md font-light text-gray-900 dark:text-white">Nombre del Examen</label>
                  <Field
                    type="text"
                    name="nombre_examen"
