...
import { createAnswersTests } from '../../../store/slices/TestsAnswers/TestsAnswersService';
...
const FormMakeTest = ({ Test }) => {
  ...
  const dispatch = useDispatch()
    ...
    const getDate = () => moment().locale('es').format('D MMM YYYY');
    ...
    // p.respuesta = respExamen
    const respExamen =  ['A', 'C', 'D']
    // const answersUser[idxPregunta] =  ['A', 'C', 'B']
      ...
      <div>
        <Formik
          ...
          
          {
            ...
            <div className='mt-2'>
              <div><span className='font-bold'>Fecha:</span> {getDate()}</div>
