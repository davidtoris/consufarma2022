      ...
      <Formik
        ...
        onSubmit={async (valores) => {
          const data = {
            ...
            ponente_uno: courseSelected.ponente_uno_id.id,
            ponente_dos: courseSelected.ponente_dos_id.id,
            especialidad_id: courseSelected.especialidad.id,
            img_curso: courseSelected.imagen,
            preguntas: valores.preguntas,
            presencialVirtual: valores.presencialVirtual,
            duracion: valores.duracion.toString(),
...

        {
          function FillInputs({ values, errors, setFieldValue, handleBlur }) {
            ...
            useEffect(() => {
              const course = coursesName.find(c => c.id === values.nombre_curso)
              if (course) {
