    ...
    <div className='max-w-7xl container mx-auto font-body grid-flow-row grid grid-cols-1 lg:grid-cols-3 gap-4 mt-5 px-2 md:px-5'>
      <div className='col-span-1 md:col-span-2 md:px-0 px-3'>
        ...
        <div className="flex justify-between">
          ...
          <div className='rating text-yellowCustom mt-5 flexitems-center'>
      ...
      <div className='sm:pl-5 px-2'>
          ...
          <div className="top-50 right-40">
            ...
            <Link href={forms}>
              <div className='bg-blueDarkCustom mt-5 rounded-md p-2 sm:py-2 py-3 text-white font-bold text-center text-xl fixed sm:relative z-10 bottom-0 w-full'>
                  Inscríbete
              </div>
            </Link>
