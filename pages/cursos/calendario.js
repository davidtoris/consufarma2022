      ...
      <div className=''>
        <div className='w-[1000px] m-auto'>
          ...
          <div className='container m-auto px-2 md:px-2 mt-0 cont-cols-calendar'>
            ...
            <div>
              <h2 className='text-4xl text-blueDarkCustom m-auto mt-6 font-bold text-center mb-8 uppercase'>Mayo</h2>
              <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 cols-calendar'>
                {cursosDate.filter(f => f.fecha_text.includes('Mayo')).map(c => (
                  <CardCalendar
                    key={c._id}
                    nombre={c.nombre}
                    fecha={c.fecha_text}
