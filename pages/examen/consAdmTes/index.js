            ...
            <tr className='border-2 text-1enter' key={t.id}>
              ...
              <td className='border-2 border-gray-200 p-1'>
                <div className='flex text-xl justify-center px-1'>
                  <Link href={`/examen/consAdmTes/${t.id}`}>
                  ...
                  <div onClick={() => copyLink(`${URL_SITE}/examen/${t.id}`)} className='cursor-pointer hover:scale-110 transition-all mx-2'><VscCopy title="Copiar Link" className='text-gray-500' /></div>
                  <div onClick={() => handlePrint(t.id)} className='cursor-pointer hover:scale-110 transition-all'><BsFileEarmarkPdf title='Ver Examen en PDF' className='text-gray-500' /></div>
                  <div onClick={() => setOpenModal(t.nombre_examen, t.id)} className='cursor-pointer hover:scale-110 transition-all ml-2'><IoTrashOutline title="Eliminar Examen" className='text-gray-500' /></div>
                  ...
                  <Link href={`/examen/consAdmTes/enviarExamen/${t.id}`}>
